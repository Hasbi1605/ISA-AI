...
REALTIME_HIGH_PATTERNS = [
    ...
    r"\b(isu|issue|kabar|perkembangan|kasus|kontroversi)\b.*\b(terkini|terbaru|hari\s+ini|sekarang)\b",
    r"\b(terkini|terbaru|hari\s+ini|sekarang)\b.*\b(isu|issue|kabar|perkembangan|kasus|kontroversi)\b",
    r"\b(cari|cek|telusuri|browse|search|ringkas|rangkum)\b.*\b(terkini|terbaru|hari\s+ini|sekarang)\b",
