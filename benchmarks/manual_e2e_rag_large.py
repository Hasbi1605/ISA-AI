...
if not TOKEN:
    raise RuntimeError("AI_SERVICE_TOKEN wajib diisi untuk menjalankan test E2E RAG besar.")
HEADERS = {
...
def run_large_test():
    ...
    try:
        response = requests.delete(delete_url, headers=HEADERS, params={"user_id": "test_e2e_large_user"})
        response.raise_for_status()
