...
- Menghapus teks instruksi lampiran yang permanen di bawah input chat utama, tetapi tetap mempertahankan disclaimer footer.
...
3. Hilangkan helper text attachment yang persisten dari composer chat utama; disclaimer `ISTA AI dapat keliru...` tetap dirender sebagai footer singkat.
...
## Risiko
- Test lama mungkin masih mengharapkan pesan load memo.
