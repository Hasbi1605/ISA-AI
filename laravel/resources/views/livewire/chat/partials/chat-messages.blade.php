                        ...
                        <div
                            ...
                            <div data-answer-actions class="mt-2 flex flex-wrap items-center gap-1 text-[12px] text-[#64748B] dark:text-[#94A3B8]">
                                <button
                                    ...
                                    >
                                    <svg class="h-[17px] w-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                                ...
                                <button
                                    ...
                                    class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-[#25D366] transition hover:bg-white/80 hover:text-[#128C7E] dark:hover:bg-gray-800/80 dark:hover:text-[#25D366]"
                                >
                                ...
                                <div class="relative" x-on:click.outside="driveMenuOpen = false">
                                    ...
                                    >
                                        ...
                                        <img x-show="!driveLoading" src="{{ $uiIcons['googleDrive'] }}" alt="" class="h-[18px] w-[20px]" />
