                        ...
                        <div
                            ...
                            <div data-answer-actions class="mt-2 flex flex-wrap items-center gap-1 text-[12px] text-[#64748B] dark:text-[#94A3B8]">
                                ...
                                <button
                                    ...
                                    class="inline-flex h-8 w-8 items-center justify-center rounded-lg transition hover:bg-white/80 hover:text-[#128C7E] dark:hover:bg-gray-800/80 dark:hover:text-[#25D366]"
                                >
